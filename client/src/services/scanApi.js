...
/**
 * Get containers assigned to the current warehouse
 * Returns shipments with container scan stats for warehouse scanning
 *
 * @returns {Promise<Object>} Assigned containers data with scan stats
 */
