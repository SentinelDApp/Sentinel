...
const createTransporter = () => {
  ...
  console.log(`📧 Creating Zoho SMTP transporter for: ${process.env.EMAIL_USER}`);
...
const sendEmail = async ({ to, subject, html }) => {
  ...
  const mailOptions = {
    from: `"Sentinel Supply Chain" <${process.env.EMAIL_USER}>`,
    to,
    subject,
    html
  };
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <a href="${frontendUrl}/signup" class="cta-button">
            Apply Again →
          </a>
        </div>
        <div class="footer">
