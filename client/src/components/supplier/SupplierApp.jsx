...
const NavigationTabs = ({
  ...
  return (
    <nav
      className={`
      sticky top-0 z-40 backdrop-blur-xl border-b transition-colors duration-200
      ${
        isDarkMode
        ...
        <div className="flex items-center gap-1 py-3 overflow-x-auto">
          {tabs.map((tab) => (
            <button
              ...
              className={`relative flex items-center gap-2 px-5 py-2.5 text-sm font-medium rounded-xl whitespace-nowrap transition-all duration-200 ${
                activeTab === tab.id
                  ? isDarkMode
            ...
            >
              ...
              <span>{tab.label}</span>
              {tab.badge && (
                <span className="ml-1 min-w-5 h-5 px-1.5 bg-red-500 text-white text-xs rounded-full flex items-center justify-center font-semibold">
                  {tab.badge}
                </span>
              )}
            </button>
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                ...
                >
                  <p className="text-3xl font-bold text-green-500">
                    {
                      shipments.filter((s) => s.isLocked || s.blockchainTxHash)
                        .length
                    }
                  </p>
                  <p
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1 flex-wrap">
                            ...
                            >
                              {STATUS_COLORS[selectedShipment.status]?.label ||
