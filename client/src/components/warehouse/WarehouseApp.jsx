...
const DispatchForm = ({ shipment, retailers, onDispatch, isDarkMode }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        🚚 Dispatch to{" "}
        {retailers.find((r) => r.id === selectedRetailer)?.name || "Retailer"}
      </button>
...
const WarehouseDashboardContent = ({ page }) => {
  ...
  const loadShipments = useCallback(async () => {
    ...
    try {
      ...
      const warehouseShipments = result.shipments.map((shipment) => ({
        ...
        supplier: "Supplier", // For backward compatibility
        ...
        transporterName:
          shipment.assignedTransporter?.name || "Assigned Transporter",
        concerns: [],
      }));
  ...
  // If page is 'profile', render profile page (after all hooks)
  if (page === "profile") {
    return (
      <div
                    ...
                    >
                      ...
                      {selectedShipment?.status ===
                        ...
                        <div className="space-y-3">
                          ...
                          <button
                            onClick={() =>
                              handleMarkReadyForDispatch(selectedShipment.id)
                            }
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                `}
                  >
                    ...
                    >
                      Select a shipment from the list to view details and take
                      actions
                    </p>
                  </div>
                )}
